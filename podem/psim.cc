...
void CIRCUIT::ParallelLogicSimVectors()
{
    ...
    float Ave_gate_evaluation = (float) gate_evaluation / pattern_num;
    cout << "Average gate evaluation: " << Ave_gate_evaluation << endl;
    cout << "Percentage of gate     : " << (float) 100 * Ave_gate_evaluation / No_Gate() << endl;
}
