...
class CIRCUIT
{
    private:
        ...
        // ass4
        list<FAULT*> CP_Flist; // collapsing checkpoint fault list
        list<FAULT*> UCP_Flist; // undetected checkpoint fault list
        list<BFAULT*> B_Flist;
        list<BFAULT*> UB_Flist;


        long long gate_evaluation;
        void GenParallel(bool);
    ...
    public:
        ...
        void GetGate();  // ass0
        void GetNet();   // ass0
        void GetPath(string start, string end);  // ass1
        void DFS(GATE*);
        // member in path finding
        vector<bool> visit;
        vector<string> path;
        GATE *start, *end;
        int path_num;
        ...
        void GeneratePattern(int, bool, string);
        void ModLogicSimVectors();
        void ModLogicSim();
        VALUE CPU_Evaluate(GATEPTR gptr);
        ...
        void GenerateBridgeFaultList(string);
        ...
        // defined in sim_gen.cc
        void SimulatorGenerate(string, string);
